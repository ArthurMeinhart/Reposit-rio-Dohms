...
# A resolução do problema do código está na linha 58
...
def resultado_final():
    ...
    atualizar_contagem_geral()  #Para resolver o problema do código anterior, só é preciso chamar a função que atualiza a contagem geral quando a partida for reiniciada. 
