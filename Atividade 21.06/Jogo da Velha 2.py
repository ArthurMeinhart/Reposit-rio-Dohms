...
class JogoDaVelha:
    def __init__(self):
        ...
        # Apenas retirando as duas linhas que usavam métodos não importados para o código, o programa volta a funcionar normalmente com as alterações de interface que eu havia pedido. 
